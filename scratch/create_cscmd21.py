...
tex_content = r"""% BHU PYQ -- Professional Exam Template
...
\hypersetup{colorlinks=true,urlcolor=black,linkcolor=black,
  pdftitle={CSCMD21: Introduction to Information Technology -- BHU PYQ 2024-25}}

\pagestyle{fancy}\fancyhf{}
\renewcommand{\headrulewidth}{0.4pt}\renewcommand{\footrulewidth}{0.4pt}
\fancyhead[L]{\small\textit{Banaras Hindu University}}
\fancyhead[R]{\small\textit{CSCMD21: Introduction to IT}}
...
tex_path = '/Users/aryanmaurya/exam portal/aaa/cs/2024-25_UG_II-Sem_B.Sc._-_COMPUTER_SCIENCE_CSCMD21.tex'
with open(tex_path, 'w') as f:
    f.write(tex_content.strip())
print(f'Wrote LaTeX file to: {tex_path}')

src_pdf = '/Users/aryanmaurya/exam portal/aa nep/CSCMD21 Introduction to Information Technology, 2024-25(NEP).pdf'
dst_pdf = '/Users/aryanmaurya/exam portal/aaa/cs/2024-25_UG_II-Sem_B.Sc._-_COMPUTER_SCIENCE_CSCMD21.pdf'
shutil.copy(src_pdf, dst_pdf)
print(f'Copied PDF to: {dst_pdf}')
