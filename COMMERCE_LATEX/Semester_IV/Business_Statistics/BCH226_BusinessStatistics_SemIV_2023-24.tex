...
\begin{parts}
  \item A total of 10 samples of 8 each was drawn from a universe. The average range ($ar{R}$) and average standard deviation ($ar{\sigma}$) of these samples were 0.0811 and 0.0263 respectively. Estimate the standard deviation of the universe from which these samples were drawn when $d_2 = 2.847$ and $c_2 = 0.9027$.\pts{7}
  \item If $ar{X} = 0.8768$, $ar{R} = 0.0026$ and given that $A_2 = 0.58$, $D_3 = 0$ and $D_4 = 2.115$. Compute UCL and LCL for $ar{X}$ and $R$ chart.\pts{7}
\end{parts}
