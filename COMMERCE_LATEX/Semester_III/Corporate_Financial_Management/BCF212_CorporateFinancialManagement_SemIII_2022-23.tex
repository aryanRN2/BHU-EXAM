...
\hypersetup{
    ...
    urlcolor=black,
    linkcolor=black,
    pdftitle={BCF-212: Corporate Financial Management -- BHU B.Com. (Hons.) FMM Sem III 2022-23}
}
...
Explain the nature and scope of Corporate Finance.\pts{14}

\centerline{   \textbf{OR}}

``The goal of profit maximization does not provide an operationally useful criterion for measuring the success of business operations.'' Explain this statement.\pts{14}
...
Explain the characteristics of a Sound Financial Plan.\pts{14}
...
What do you mean by overcapitalisation? Discuss the causes and remedies of overcapitalisation.\pts{14}

\centerline{   \textbf{OR}}

Distinguish between capitalisation and capital structure.\pts{14}
