...
\begin{parts}
  \item Define an unbiased estimator. What are the criteria of a good estimator? Show that $2\bar{X}$ is an unbiased estimator of $\theta$ in the rectangular distribution $U(0, \theta)$. \pts{7}
  \item State and prove the invariance property of a consistent estimator. Let $X_1, X_2, \ldots, X_n$ be a random sample from a Bernoulli population with parameter $\theta$. Show that $\bar{X}(1 - \bar{X})$ is a consistent estimator of $\theta(1-\theta)$. \pts{7}
\end{parts}
