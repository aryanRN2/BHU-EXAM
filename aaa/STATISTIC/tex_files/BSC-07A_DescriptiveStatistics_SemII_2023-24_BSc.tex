...
, 2, 2, 3, 3, 4, 4, 5, 5, 6, 2, 2, 3, 4, 5, 6, 3, 4, 4, 4, 4, 4, 4, 5, 2, 2, 3, 4,4, \pts{5}

Construct the frequency distribution for the above data set. Also construct the
cumulative and relative frequency tables.
\begin{parts}
  \item What are the different types of classification available to represent the raw data set?Explain with suitable example.
\end{parts}
\medskip\rule{\linewidth}{0.2pt}
