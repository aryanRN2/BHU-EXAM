...
\begin{parts}
  ...
  \item In a stratification with two strata, $W_1 = 0.8$, $W_2 = 0.2$, $S_1 = 2$ and $S_2 = 4$. Compute the sample sizes $n_1$ and $n_2$ (ignoring the finite population correction) if the standard error of the estimated population mean $\bar{y}_{st}$ is to be $0.1$ and the total sample size $n = n_1 + n_2$ is to be minimized. \pts{7}
\end{parts}
