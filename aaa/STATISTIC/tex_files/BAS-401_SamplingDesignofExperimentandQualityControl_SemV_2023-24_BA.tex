...
\begin{parts}
  ...
  \[
  Var(ar{y}_n) = \frac{N-n}{Nn} S^2
  \] \pts{7}
  \item If $ar{y}_n$ is the sample mean of a random sample of size $n$ drawn from a population of size $N$ by the method of SRSWOR, prove that it is an unbiased estimator of the population mean, i.e.,
  \[
  E(ar{y}_n) = ar{Y}_N
  \] \pts{7}
\end{parts}
...
\[
ar{y}_{st} = \sum_{i=1}^{k} W_i ar{y}_i
\]
under proportional allocation, where $W_i = N_i/N$ and $ar{y}_i$ is the sample mean of the $i$-th stratum drawn using SRSWOR. \pts{14}
\medskip\rule{\linewidth}{0.2pt}
...
Define linear systematic sampling. Prove that the systematic sample mean $ar{y}_{sys}$ is an unbiased estimator of the population mean $ar{Y}_N$. Also prove that:
\[
Var(ar{y}_{sys}) = \frac{N-1}{N} S^2 - \frac{k(n-1)}{N} S^2_{wsy}
\]
...
Describe cluster sampling. In the case of equal cluster sampling, prove that the sample mean $ar{y}_{cl}$ is an unbiased estimator of the population mean $ar{Y}_N$. Also, write down the expression of $Var(ar{y}_{cl})$ in terms of the intra-class correlation coefficient $\rho$. \pts{14}
\medskip\rule{\linewidth}{0.2pt}
