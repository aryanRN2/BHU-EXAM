...
e 0$ for all $i=1, 2, \dots, n$, and let $A$ be any arbitrary event which is a subset of $igcup_{i=1}^n E_i$, then calculate $P(E_i|A)$ for all $i=1, 2, \dots, n$ in the case when $P(A)>0$.
