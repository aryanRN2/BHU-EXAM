...
Discuss the construction of the $(ar{X}, R)$-chart, explaining the role of control limits and the rationale for using the range $R$ as a measure of variability. \pts{14}
