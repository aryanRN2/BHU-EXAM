...
\begin{parts}
  ...
  \item Give a brief history of the Census of India. \pts{7}
\end{parts}
...
\begin{parts}
  \item What do you mean by a life table? Discuss the relationships among the various columns of a complete life table. \pts{7}
  \item Define Gross Reproduction Rate (GRR) and Net Reproduction Rate (NRR). Explain how far they can be considered as indices of population growth. Interpret the following:
  \begin{parts}
...
\begin{parts}
  \item What are control charts? Describe the main principles of Statistical Quality Control (SQC) charts. Discuss the need and utility of SQC in industry. \pts{7}
  \item Describe control charts for mean ($\bar{X}$-chart) and standard deviation ($S$-chart). \pts{7}
\end{parts}
...
\begin{parts}
  ...
  \item Explain the additive and multiplicative models of time series, stating clearly the assumptions underlying each. \pts{7}
\end{parts}
...
\begin{parts}
  \item Discuss in detail the construction of the $p$-chart and $c$-chart for attributes in statistical quality control. \pts{7}
  \item Explain the moving average method of trend elimination. How does one choose the appropriate length of the moving average? \pts{7}
\end{parts}
