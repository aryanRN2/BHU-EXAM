...
\begin{parts}
  \item Define the geometric distribution and prove that it satisfies the lack of memory property. If $ar{X}$ is the sample mean of $n$ i.i.d. random variables, show that $M_{ar{X}}(t) = [M_X(t/n)]^n$. \pts{7}
