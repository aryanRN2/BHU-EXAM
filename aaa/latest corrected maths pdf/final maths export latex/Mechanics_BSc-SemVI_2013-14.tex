...
\begin{parts}
  ...
  \item If $A$ and $B$ are the moments of inertia of a uniform lamina about two perpendicular axes $Ox$ and $Oy$ lying in its plane, and $F$ is the product of inertia of the lamina about these axes, show that the principal moments at $O$ are equal to $\dfrac{1}{2}igl(A+B \pm \sqrt{(A-B)^2 + 4F^2}igr)$. \pts{6}
\end{parts}
