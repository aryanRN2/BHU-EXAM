...
\begin{parts}
  ...
  \] \pts{8}
  \item Define an inner product space. Let $x = (x_1, x_2, \dots, x_n)$ and $y = (y_1, y_2, \dots, y_n)$ in $\mathbb{C}^n$. Define $(x, y) = x_1 \bar{y}_1 + x_2 \bar{y}_2 + \dots + x_n \bar{y}_n$. Show that $\mathbb{C}^n$ is an inner product space. \pts{6}
\end{parts}
