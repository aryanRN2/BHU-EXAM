...
\medskip
\noindent\textbf{Question 2.} What is a simple linear regression model? Obtain the ordinary least squares expressions for the estimators $\beta_0$ and $\beta_1$.
...
\begin{parts}
  ...
  \[ f(x) = \begin{cases} \frac{3}{56}x^2 & \text{if } 2 < x < 4 \\ 0 & \text{otherwise} \end{cases} \]
