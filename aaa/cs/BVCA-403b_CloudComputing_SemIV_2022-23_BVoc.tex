...
\hypersetup{colorlinks=true,urlcolor=black,linkcolor=black,
  pdftitle={BVCA-403b: Cloud Computing -- BHU PYQ}}
...
\fancyhead[R]{\small\textit{BVCA-403b: Cloud Computing}}
...
\begin{center}
  ...
  {\large\bfseries Paper: BVCA-403b --- Cloud Computing}\\[4pt]
...
—\_ 1. What do you mean by critical thinking ?
\begin{parts}
  \item Describe the different barriers to critical
  , thinking.
  REFNO 065163
\end{parts}
...
\medskip\noindent\textbf{Question 5.} (a) Describe the benefits of critical thinking. | \_
\begin{parts}
  \item Highlight the importance of critical
  thinking in life.
  \item How critical thinking helps employees at
workplace ? Discuss.
  \item Discuss how critical thinking makes
  * personal life better. |
  (e}) Why design thinking skills matter ?
  Discuss.
  2
  REFNO 065163
...
Note: Answer each of the following questions in a
word or a sentence. Each question carries
1 mark, ‘ 10x1=10
. 6. (a) Who introduced the term critical thinking ?
\begin{parts}
  \item Explain consistency as critical thinking
  standard.
  \item Differentiate between argument and
  explanation.
  \item Why people with critical thinking skills are
  in demand by organizations ?
  {e) Why should we study logic ?
  [= |
  REFNO 065163
  \item What is meant by reflective thinking 2
  \item What is not an argument ? | |
  \_ (h) Give the meaning of argument.
  \item What is meant by analytical skills ? |
  \item How one can practice active listening ? |
  seek
  * 4 |
  : - 4 200 :
\end{parts}
