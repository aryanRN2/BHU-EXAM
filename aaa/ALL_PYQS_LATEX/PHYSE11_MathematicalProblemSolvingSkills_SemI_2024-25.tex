...
\begin{parts}
  ...
  \item Prove that the vector field $\vec{F}(x, y, z) = y^2 z \hat{i} + x^2 y \hat{j} - z \hat{k}$ is a rotational field.\pts{3.5}
  \item Find the divergence of the vector $\vec{A} = 4x \hat{i} - 2y^2 \hat{j} - 9 \hat{k}$.\pts{3.5}
