...
\begin{parts}
  ...
  \item Consider the polynomial $p(x) = x^3 - 5x^2 + 9x - 5$. If $\alpha, \beta, \gamma$ are the roots of $p(x)$, find the value of $\alpha + \beta + \gamma$, $\alpha\beta + \beta\gamma + \gamma\alpha$, $\alpha\beta\gamma$, and $\alpha^2 + \beta^2 + \gamma^2$.\pts{2}
\end{parts}
