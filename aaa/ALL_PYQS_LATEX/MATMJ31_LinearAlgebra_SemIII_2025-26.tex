...
\begin{parts}
  ...
  \item Define invariant subspace of a vector space. Let $S = \{W_i\}_{i \in I}$ be a family of $T$-invariant subspaces of a vector space $V$, then show that $W = igcap_{i \in I} W_i$ is also $T$-invariant.\pts{2}
  ...
  \item Define Bilinear form and Quadratic form. Let $f: \mathbb{R}^n  \times \mathbb{R}^n  o \mathbb{R}$ be defined by $f(x,y) = \alpha_1 eta_1 + \alpha_2 eta_2 + \dots + \alpha_n eta_n$ where $x = (\alpha_1, \dots, \alpha_n)$ and $y = (eta_1, \dots, eta_n)$. Show that $f$ is a bilinear form.\pts{3}
\end{parts}
...
\begin{parts}
  \item If the matrix of a linear transformation $T: \mathbb{R}^2  o \mathbb{R}^2$ with respect to the ordered basis $B = \{(1,0), (0,-1)\}$ is $
\begin{pmatrix} 1 & 1 \\ 1 & 1 \end{pmatrix}$, what is the matrix of $T$ with respect to the ordered basis $B' = \{(1,1), (1,-1)\}$?\pts{5}
